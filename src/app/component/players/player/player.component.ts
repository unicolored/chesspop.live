  ...
  template: `
    <div class="app-player">
      <div class="badge">
        ...
        >
          <path
            d="M12 2a2 2 0 0 0-2 2v3H8a2 2 0 0 0-2 2v1H4v2h2v7a2 2 0 0 0 2 2h8a2 2 0 0 0 2-2v-7h2v-2h-2V9a2 2 0 0 0-2-2h-2V4a2 2 0 0 0-2-2zm-2 7v3h-2V9h2zm4 0v3h-2V9h2z"
          />
        </svg>
